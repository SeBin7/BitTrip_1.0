...
<body>
	<div id="wrapper">
				...
				<div class="navbar-collapse collapse ">
					<ul class="nav navbar-nav">
						...
						<li class="dropdown"><a href="#" class="dropdown-toggle "
							...
							data-close-others="false">일정 만들기 <b class=" icon-angle-down"></b></a>
							<ul class="dropdown-menu">
								<li><a href="typography.html">? </a></li>
								<li><a href="components.html">?</a></li>
								<li><a href="pricingbox.html">?</a></li>
							</ul></li>
						<li><a href="portfolio.html">여행 정보</a></li>
						<li><a href="#">여행 목록</a></li>
						...
						<ul class="slides">
							<li><img src="img/slides/1.jpg" alt="" />
								<div class="flex-caption">
									<h3>편안한 여행 </h3>
									<p>복잡한 여행계획 세우지 마세요</p>
									<a href="#" class="btn btn-theme">Learn More</a>
								</div></li>
							<li><img src="img/slides/2.jpg" alt="" />
								<div class="flex-caption">
									<h3>편안한 여행</h3>
									<p>복잡한 여행 계획 세우지 마세요 !</p>
									<a href="#" class="btn btn-theme">Learn More</a>
								</div></li>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="big-cta">
						<div class="cta-text">
							<h2>
								<span>BitTrip</span> 여행 Community
							</h2>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-12">
					<h4 class="heading">국내 Best Travel Plan</h4>
					<div class="row">
						<section id="projects">
							...
							<li class="col-lg-3 design" data-id="id-0" data-type="web">
								<div class="item-thumbs">
									...
									<a class="hover-wrap fancybox" data-fancybox-group="gallery"
										title="${vo1.title}" href="img/works/1.jpg"> <span
				...
				<div class="col-lg-12">
					<h4 class="heading">해외 Best Travel Plan</h4>
					<div class="row">
						<section id="projects">
						<ul id="thumbs" class="portfolio">
							<!-- Item Project and Filter Name -->
			...
			<div class="row">
				<div class="col-lg-3">
					<div class="widget">
						...
						<address>
							<strong>BitTrip company Inc</strong><br>  Test<br>
						</address>
						<p>
