        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.html"><span>B</span>it Trip</a>
                </div>
                <div class="navbar-collapse collapse ">
                    <ul class="nav navbar-nav">
                        <li class="active"><a href="index.html">í</a></li>
                        <li class="dropdown">
                            <a href="typography.jsp">ì¼ì  ë§ë¤ê¸°</a>
                            
                        </li>
                        <li><a href="portfolio.jsp">ì¬íì ë³´</a></li>
...
<form action="login.do" method="POST" class="signUp" id="signupForm" >
   ...
   <input type="text" name="email" class="signUpInput" placeholder="Type your eamil" autofocus required>
		...
		<div class="row">
			<div class="col-lg-3">
				<div class="widget">
					...
					<address>
					<strong>BitTrip company Inc</strong><br>
					 ìì¸ì ê°ë¨êµ¬ ì­ì¼ë<br>
					 ì¼ì±SDS ë©í°ìº í¼ì¤ 1402í¸ </address>
					<p>
						<i class="icon-phone"></i> 02-1234-5678<br>
						<i class="icon-envelope-alt"></i> BitTrip@BitTrip.com
					</p>
				</div>
			</div>
			<div class="col-lg-3">
				...
				<div class="col-lg-6">
					<div class="copyright">
                        ...
                        <div class="credits">
                            ...
                            -->
                            <a href="https://bootstrapmade.com/">ë©ì¸ íì´ì§</a> by <a href="https://bootstrapmade.com/">ì ì : ë´ê°</a>
                        </div>
					</div>
				</div>
			</div>
